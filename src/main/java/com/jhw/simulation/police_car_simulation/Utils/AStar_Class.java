/**
 ** AStar.java * * Copyright 2011 by Sarah Wise, Mark Coletti, Andrew Crooks,
...
public class AStar_Class {

    public LinkedList<GeomPlanarGraphDirectedEdge> astarPath(Node start, Node goal) {
        ...
        LinkedList<GeomPlanarGraphDirectedEdge> result = new LinkedList<>();

        // containers for the metainformation about the Nodes relative to the
        // A* search
        HashMap<Node, AStarNodeWrapper> foundNodes = new HashMap<>();
        ...
        LinkedList<AStarNodeWrapper> closedSet = new LinkedList<>(),
     ...
     */
    LinkedList<GeomPlanarGraphDirectedEdge> reconstructPath(AStarNodeWrapper n) {
        LinkedList<GeomPlanarGraphDirectedEdge> result = new LinkedList<>();
    ...
    /**
     * Measure of the estimated distance between two Nodes. Extremely basic,
     * just Euclidean distance as implemented here.
     *
     * @param x
     * @param y
     ...
     * @return
     */
    AStarNodeWrapper findMin(LinkedList<AStarNodeWrapper> set) {
