package PoliceCarsSimulation;

import Agents.Patrol;
import Chart.*;
import Inner.AreaColor_Class;
import Reimplementations.MyDisplay2D;
import Portrayals.RoadsLabelPortrayal;
import java.awt.*;
...
public class PoliceCarsSimulation_UI extends GUIState {
    ...
    public void generateAtPosition(LocationWrapper loc) {
        Inner.AgentType_Enum type = SimulationMain.getTipeNewInserted();
        switch (type) {
